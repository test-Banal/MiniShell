...
/*   Updated: 2024/09/05 14:52:31 by roarslan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//is_simple_command + comme ca ???
//bool	ft_simple_cmd(t_cmd *cmd)
// {
// 	int	pid;
// 	int	status;
...
// 	else
// 		return (false);
// 	handle_exitcode(cmd, 0, status);
// 	return (/*surement rajouter une fonction de fin genre ft_Close ou free_cmd/ free_data */true);
// }
...
//!!!rajouter fonction free_pids pour eviter des leaks !!!
